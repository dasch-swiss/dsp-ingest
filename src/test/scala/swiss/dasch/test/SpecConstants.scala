...
import swiss.dasch.domain.{ Asset, AssetId, GenericAsset, ProjectShortcode, Sha256Hash }
...
object SpecConstants {
  ...
  object Assets   {
    val existingAsset: Asset = GenericAsset(AssetIds.existingAsset, existingProject)
  }
  extension (s: String) {
